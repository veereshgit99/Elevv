      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-50 to-blue-50 p-12 flex-col justify-center">
        <div className="max-w-md">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Access your analysis history, discover new insights, and continue to perfect your resume.
          </p>

          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-[#FF5722]"></div>
              <span className="text-gray-700">Track your job application progress</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-[#FF5722]"></div>
              <span className="text-gray-700">Get personalized resume recommendations</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-2 h-2 rounded-full bg-[#FF5722]"></div>
              <span className="text-gray-700">Access your saved job matches</span>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                <div className="flex items-center justify-end">
                  <Link href="/forgot-password" className="text-sm text-[#FF5722] hover:text-[#E64A19]">
                    Forgot Password?
                  </Link>
                </div>

                {/* --- ADD THIS LINE --- */}
                {/* This will display the error message if the 'error' state is not null */}
                {error && <p className="text-red-500 text-sm">{error}</p>}

                <Button type="submit" className="w-full bg-[#FF5722] hover:bg-[#E64A19] text-white h-11">
                  Log In
                </Button>
              </form>
              ...
              <div className="text-center">
                <span className="text-sm text-gray-600">
                  ...
                  <Link href="/signup" className="font-medium text-[#FF5722] hover:text-[#E64A19]">
                    Sign up
                  </Link>
                </span>
              </div>
