...
COGNITO_USER_POOL_ID = os.getenv("COGNITO_USER_POOL_ID", "us-east-2_fVaPyPRfl")
COGNITO_APP_CLIENT_ID = os.getenv("COGNITO_APP_CLIENT_ID", "13e9ua65iqciiti9l3apic4k3e")
COGNITO_APP_CLIENT_SECRET = os.getenv("COGNITO_APP_CLIENT_SECRET", "7jf5mb0n04im6h7tlohtuo3qnpkjpl8nak04k25o4s6cndccgqt")
